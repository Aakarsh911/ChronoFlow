  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="lg:hidden text-center mb-8">
        ...
        <p className="text-xl text-slate-700 font-semibold">Master Your Time</p>
      </div>
      ...
      <Card className="bg-white border-slate-200 shadow-2xl overflow-hidden">
        ...
        <div className="p-10 space-y-8">
          ...
          <Button
            variant="outline"
            size="lg"
            className="w-full h-14 text-base font-semibold bg-white hover:bg-gray-50 text-gray-900 hover:text-gray-900 border-2 border-slate-300 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-[1.02]"
      ...
      <div className="mt-8 text-center">
        <p className="text-slate-500 text-sm font-medium mb-4">Trusted by productivity professionals</p>
